...
ActiveRecord::Schema[7.1].define(version: 2024_07_30_205813) do
  ...
  create_table "flight_details", force: :cascade do |t|
    ...
    t.bigint "connections_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["connections_id"], name: "index_flight_details_on_connections_id"
    t.index ["flight_id"], name: "index_flight_details_on_flight_id"
  end

  create_table "flights", force: :cascade do |t|
    t.integer "fare_category"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "flight_details", "flight_details", column: "connections_id"
